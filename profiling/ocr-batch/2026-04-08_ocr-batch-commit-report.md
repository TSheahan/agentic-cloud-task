...
|-------|----------------|------------------------|--------|
| Round 4 ONNX + spacing params | [`dev-benchmark/r4-onnx-spacing.py`](dev-benchmark/r4-onnx-spacing.py) | **~48** | Partial GPU (RapidOCR ONNX on CPU). |
| Round 5 torch + spacing | [`dev-benchmark/r5-torch-spacing.py`](dev-benchmark/r5-torch-spacing.py) | **~25.7** | Full GPU OCR stack. |
| Round 6 paddle + spacing | [`dev-benchmark/r6-paddle-spacing.py`](dev-benchmark/r6-paddle-spacing.py) | **~22.0** | |
| Round 7 paddle tuned | [`dev-benchmark/r7-paddle-tuned.py`](dev-benchmark/r7-paddle-tuned.py) | **~21.7** | `text_score=0.6`, `Det.score_mode=slow`, `Rec.use_space_char` via `rapidocr_params`. |
